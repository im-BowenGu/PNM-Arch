...
REFS = [
    ...
    "B. Gu. Bypassing the HBM wall: Verilog HDL sources, Go co-simulation harness, and manuscript repository. https://github.com/im-BowenGu/PNM-Arch, 2026.",
...
def latex_source(text: str, review: bool) -> str:
    ...
    if review:
        ...
        date = "July 30, 2026 (review copy)"
        head = r"""
\usepackage{fancyhdr}
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\footnotesize Review copy}
\fancyhead[R]{\footnotesize Bypassing the HBM Wall}
