...
// =============================================================================
// orchestrator_chip_haskell — Haskell-optimized Router Chip (FP64 workloads)
//
// Variant of orchestrator_chip for Haskell programs requiring FP64 precision.
// Functionally identical to orchestrator_chip but parameterized for:
...
// =============================================================================
module orchestrator_chip_haskell #(
    ...
    // Instantiate the base orchestrator chip with Haskell FP64 parameters.
