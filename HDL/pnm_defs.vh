...
// orchestrator-injected requests and pass-through, 0 for node-egress results); it
...
// 0->1 (board egress -> spine ascent) at the lxy_repeater attachment.
...
// relative to the board's lxy_repeater:
//   [10:7] LAYER : 4-bit layer ID (1-based, matches LAYER_ID low nibble)
//   [6]    AXIS  : 0 = X, 1 = Y
//   [5]    SIGN  : 0 = +, 1 = -
//   [4:0]  DIST  : hop distance from the lxy_repeater (0..31)
