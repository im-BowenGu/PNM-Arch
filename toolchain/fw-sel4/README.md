# fw-sel4 — seL4 microkernel root task for orchestrator_sbc

Builds a minimal seL4 root task for the `orchestrator_sbc` chip family.
...
- CMake >= 3.18
- `riscv32-unknown-elf-gcc` cross compiler (available in `flake.nix`)
