...
- `HDL/` - Verilog-2005 fabric model + compute units + testbenches (all passing)
- `sim/` - Go co-simulation harness (stdlib only): topology/tb generators, virtual execution units, LLM inference client, model compiler, driver, firmware
